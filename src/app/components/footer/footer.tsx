        ...
        <div className=" relative  bottom-[111px]    md:relative  md:bottom-[255px]    lg:relative  lg:bottom-[453px]">
              ...
              <hr className="border-t-2 w-[322px] md:w-[488px] lg:w-[655px]  border-[#0000001A]   pb-[11px]   opacity-10% " />
                ...
                <div className="flex flex-row gap-2 justify-center ">
                  <h1 className="flex text-[#1434CB] font-bold italic rounded-[5.38px] w-[55px] bg-white items-center  h-[33px] border-[1px] border-[#D6DCE5]">VISA</h1>
                  ...
                  <div className="  rounded-[5.38px] w-[55px] flex items-center  bg-white  h-[33px] border-[1px] border-[#D6DCE5]">
                    <h1 className="italic font-bold  text-[15px] text-blue-900">Pay </h1>
                    <h1 className="text-blue-500 text-[15px] font-bold italic">Pal</h1>
                  </div>
